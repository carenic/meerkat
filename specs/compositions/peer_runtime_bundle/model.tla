...
peer_comms_EnqueueLifecycleAdded(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ peer_comms_phase' = "Ready"
       /\ UNCHANGED << runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueLifecycleAdded"] }
...
peer_comms_EnqueueLifecycleRetired(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueLifecycleRetired"] }
...
peer_comms_EnqueueLifecycleUnwired(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueLifecycleUnwired"] }
...
peer_comms_EnqueueLifecycleKickoffFailed(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueLifecycleKickoffFailed"] }
...
peer_comms_EnqueueLifecycleKickoffCancelled(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueLifecycleKickoffCancelled"] }
...
peer_comms_EnqueueSilentRequest(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueSilentRequest"] }
...
peer_comms_EnqueueActionableRequest(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueActionableRequest"] }
...
peer_comms_EnqueueActionableMessage(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueActionableMessage"] }
...
peer_comms_EnqueueResponse(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> peer_comms__NormalizedHandlingMode(packet.payload.handling_mode_present, packet.payload.handling_mode), request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueueResponse"] }
...
peer_comms_EnqueuePlainEvent(arg_raw_item_id, arg_source_name, arg_handling_mode) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ peer_comms_phase' = "Ready"
       /\ UNCHANGED << runtime_control_phase, runtime_control_current_run_id, runtime_control_pre_run_state, runtime_control_wake_pending, runtime_control_process_pending, runtime_ingress_phase, runtime_ingress_admitted_inputs, runtime_ingress_admission_order, runtime_ingress_content_shape, runtime_ingress_request_id, runtime_ingress_reservation_key, runtime_ingress_policy_snapshot, runtime_ingress_handling_mode, runtime_ingress_lifecycle, runtime_ingress_terminal_outcome, runtime_ingress_queue, runtime_ingress_steer_queue, runtime_ingress_current_run, runtime_ingress_current_run_contributors, runtime_ingress_last_run, runtime_ingress_last_boundary_sequence, runtime_ingress_wake_requested, runtime_ingress_process_requested, runtime_ingress_silent_intent_overrides, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> packet.payload.handling_mode, request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "runtime_control", variant |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> packet.payload.handling_mode, request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], source_kind |-> "route", source_route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", source_effect |-> "EnqueueClassifiedEntry", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes \cup { [route |-> "peer_candidate_enters_runtime_admission", source_machine |-> "peer_comms", effect |-> "EnqueueClassifiedEntry", target_machine |-> "runtime_control", target_input |-> "SubmitWork", payload |-> [content_shape |-> "text", handling_mode |-> packet.payload.handling_mode, request_id |-> None, reservation_key |-> None, work_id |-> packet.payload.raw_item_id], actor |-> "control_plane", effect_id |-> (model_step_count + 1), source_transition |-> "EnqueuePlainEvent"] }
...
CoreNext ==
    \/ DeliverQueuedRoute
    \/ \E arg_require_peer_auth \in BOOLEAN : \E arg_raw_item_id \in RawItemIdValues : \E arg_sender_name_known \in BOOLEAN : \E arg_sender_name \in {"alpha", "beta"} : \E arg_fallback_sender_name \in {"alpha", "beta"} : \E arg_kind \in PeerEnvelopeKindValues : \E arg_intent \in {"alpha", "beta"} : \E arg_lifecycle_peer_present \in BOOLEAN : \E arg_lifecycle_peer \in {"alpha", "beta"} : \E arg_handling_mode_present \in BOOLEAN : \E arg_handling_mode \in HandlingModeValues : \E arg_silent_intent \in BOOLEAN : \E arg_dismiss_message \in BOOLEAN : peer_comms_DropUntrustedExternal(arg_require_peer_auth, arg_raw_item_id, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message)
    \/ \E arg_raw_item_id \in RawItemIdValues : \E arg_require_peer_auth \in BOOLEAN : \E arg_sender_name_known \in BOOLEAN : \E arg_sender_name \in {"alpha", "beta"} : \E arg_fallback_sender_name \in {"alpha", "beta"} : \E arg_kind \in PeerEnvelopeKindValues : \E arg_intent \in {"alpha", "beta"} : \E arg_lifecycle_peer_present \in BOOLEAN : \E arg_lifecycle_peer \in {"alpha", "beta"} : \E arg_handling_mode_present \in BOOLEAN : \E arg_handling_mode \in HandlingModeValues : \E arg_silent_intent \in BOOLEAN : \E arg_dismiss_message \in BOOLEAN : peer_comms_DropAckExternal(arg_raw_item_id, arg_require_peer_auth, arg_sender_name_known, arg_sender_name, arg_fallback_sender_name, arg_kind, arg_intent, arg_lifecycle_peer_present, arg_lifecycle_peer, arg_handling_mode_present, arg_handling_mode, arg_silent_intent, arg_dismiss_message)
    ...
    \/ \E arg_raw_item_id \in RawItemIdValues : \E arg_source_name \in {"alpha", "beta"} : \E arg_handling_mode \in HandlingModeValues : peer_comms_EnqueuePlainEvent(arg_raw_item_id, arg_source_name, arg_handling_mode)
    \/ runtime_control_Initialize
    \/ runtime_control_AttachFromIdle
    \/ runtime_control_DetachToIdle
...
InjectNext ==
    ...
    \/ \E arg_raw_item_id \in RawItemIdValues : \E arg_source_name \in {"alpha", "beta"} : \E arg_handling_mode \in HandlingModeValues : Inject_classify_plain_event(arg_raw_item_id, arg_source_name, arg_handling_mode)
