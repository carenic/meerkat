...
meerkat_RequestDeferredToolsIdle(arg_names, arg_witnesses) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_staged_visibility_revision' = ((IF (meerkat_active_visibility_revision > meerkat_staged_visibility_revision) THEN meerkat_active_visibility_revision ELSE meerkat_staged_visibility_revision) + 1)
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_attachment_live, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_peer_ingress_configured, meerkat_silent_intent_overrides, meerkat_active_visibility_revision, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_member_count, mob_active_run_count, mob_cleanup_pending, mob_pending_spawn_count, mob_wiring_edge_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_Reset ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_pre_run_phase' = None
       /\ meerkat_silent_intent_overrides' = {}
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_attachment_live, meerkat_peer_ingress_configured, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_member_count, mob_active_run_count, mob_cleanup_pending, mob_pending_spawn_count, mob_wiring_edge_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_StopRuntimeExecutorDetached ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_pre_run_phase' = None
       /\ meerkat_silent_intent_overrides' = {}
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_attachment_live, meerkat_peer_ingress_configured, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_member_count, mob_active_run_count, mob_cleanup_pending, mob_pending_spawn_count, mob_wiring_edge_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_AcceptWithCompletionAttachedImmediate(arg_input_id, arg_request_immediate_processing, arg_interrupt_yielding, arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_attachment_live, meerkat_peer_ingress_configured, meerkat_silent_intent_overrides, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_member_count, mob_active_run_count, mob_cleanup_pending, mob_pending_spawn_count, mob_wiring_edge_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
