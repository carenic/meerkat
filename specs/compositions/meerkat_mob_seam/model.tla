...
VARIABLES meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, model_step_count, pending_inputs, observed_inputs, pending_routes, delivered_routes, emitted_effects, observed_transitions, witness_current_script_input, witness_remaining_script_inputs
...
BaseInit ==
    ...
    /\ meerkat_last_session_context_updated_at_ms = 0
    /\ mob_phase = "Running"
...
meerkat_UnregisterSessionIdle(arg_session_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_current_run_id' = None
       /\ meerkat_pre_run_phase' = None
       /\ UNCHANGED << meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_Reset ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_pre_run_phase' = None
       /\ meerkat_silent_intent_overrides' = {}
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_StopRuntimeExecutorUnbound ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_pre_run_phase' = None
       /\ meerkat_silent_intent_overrides' = {}
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_StopRuntimeExecutorAttached ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_phase' = "Attached"
       /\ meerkat_silent_intent_overrides' = {}
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_AcceptWithCompletionAttachedImmediate(arg_input_id, arg_request_immediate_processing, arg_interrupt_yielding, arg_wake_if_idle, arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_RecycleFromIdleOrRetired ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_active_fence_token' = None
       /\ meerkat_current_run_id' = None
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_ProjectRealtimeIntentIdle(arg_present) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_BeginRealtimeBindingIdle ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_PublishRealtimeSignalIdle(arg_authority_epoch, arg_next_binding_state) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_realtime_reattach_required' = FALSE
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_authority_epoch, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_McpServerConnectPendingIdle(arg_server_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_PeerRequestReceivedIdle(arg_corr_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_AdvanceSessionContextIdle(arg_updated_at_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "AdvanceSessionContext"
       /\ packet.payload.updated_at_ms = arg_updated_at_ms
       /\ ~HigherPriorityReady("meerkat_kernel")
       /\ meerkat_phase = "Idle"
       /\ (packet.payload.updated_at_ms > meerkat_last_session_context_updated_at_ms)
       /\ meerkat_phase' = "Idle"
       /\ meerkat_last_session_context_updated_at_ms' = packet.payload.updated_at_ms
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "meerkat", variant |-> "SessionContextAdvanced", payload |-> [updated_at_ms |-> packet.payload.updated_at_ms], effect_id |-> (model_step_count + 1), source_transition |-> "AdvanceSessionContextIdle"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "meerkat", transition |-> "AdvanceSessionContextIdle", actor |-> "meerkat_kernel", step |-> (model_step_count + 1), from_phase |-> meerkat_phase, to_phase |-> "Idle"]}
       /\ model_step_count' = model_step_count + 1


meerkat_AdvanceSessionContextAttached(arg_updated_at_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "AdvanceSessionContext"
       /\ packet.payload.updated_at_ms = arg_updated_at_ms
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "meerkat", variant |-> "SessionContextAdvanced", payload |-> [updated_at_ms |-> packet.payload.updated_at_ms], effect_id |-> (model_step_count + 1), source_transition |-> "AdvanceSessionContextAttached"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "meerkat", transition |-> "AdvanceSessionContextAttached", actor |-> "meerkat_kernel", step |-> (model_step_count + 1), from_phase |-> meerkat_phase, to_phase |-> "Attached"]}
       /\ model_step_count' = model_step_count + 1


meerkat_AdvanceSessionContextRunning(arg_updated_at_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "AdvanceSessionContext"
       /\ packet.payload.updated_at_ms = arg_updated_at_ms
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "meerkat", variant |-> "SessionContextAdvanced", payload |-> [updated_at_ms |-> packet.payload.updated_at_ms], effect_id |-> (model_step_count + 1), source_transition |-> "AdvanceSessionContextRunning"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "meerkat", transition |-> "AdvanceSessionContextRunning", actor |-> "meerkat_kernel", step |-> (model_step_count + 1), from_phase |-> meerkat_phase, to_phase |-> "Running"]}
       /\ model_step_count' = model_step_count + 1


meerkat_AdvanceSessionContextRetired(arg_updated_at_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "AdvanceSessionContext"
       /\ packet.payload.updated_at_ms = arg_updated_at_ms
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "meerkat", variant |-> "SessionContextAdvanced", payload |-> [updated_at_ms |-> packet.payload.updated_at_ms], effect_id |-> (model_step_count + 1), source_transition |-> "AdvanceSessionContextRetired"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "meerkat", transition |-> "AdvanceSessionContextRetired", actor |-> "meerkat_kernel", step |-> (model_step_count + 1), from_phase |-> meerkat_phase, to_phase |-> "Retired"]}
       /\ model_step_count' = model_step_count + 1


meerkat_AdvanceSessionContextStopped(arg_updated_at_ms) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "AdvanceSessionContext"
       /\ packet.payload.updated_at_ms = arg_updated_at_ms
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "meerkat", variant |-> "SessionContextAdvanced", payload |-> [updated_at_ms |-> packet.payload.updated_at_ms], effect_id |-> (model_step_count + 1), source_transition |-> "AdvanceSessionContextStopped"] }
       /\ observed_transitions' = observed_transitions \cup {[machine |-> "meerkat", transition |-> "AdvanceSessionContextStopped", actor |-> "meerkat_kernel", step |-> (model_step_count + 1), from_phase |-> meerkat_phase, to_phase |-> "Stopped"]}
       /\ model_step_count' = model_step_count + 1
...
meerkat_BeginLiveTopologyReconfigureIdle(arg_authority_epoch) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_MarkLiveTopologyDetachedIdle ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_phase, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
mob_SpawnRunning(arg_agent_identity, arg_agent_runtime_id, arg_fence_token, arg_generation, arg_external_addressable) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
...
mob_ObserveRuntimeReady(arg_agent_runtime_id, arg_fence_token) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ mob_phase = "Running"
       /\ mob_phase' = "Running"
       /\ UNCHANGED << meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_live_runtime_ids, mob_externally_addressable_runtime_ids, mob_runtime_fence_tokens, mob_active_run_count, mob_pending_spawn_count, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
mob_ObserveRuntimeRetired(arg_agent_runtime_id, arg_fence_token) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_pending_spawn_count, mob_coordinator_bound, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
mob_ResetMember(arg_agent_identity, arg_agent_runtime_id, arg_fence_token, arg_generation, arg_external_addressable) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ mob_pending_spawn_count' = 0
       /\ mob_identity_to_runtime' = MapSet(mob_identity_to_runtime, packet.payload.agent_identity, packet.payload.agent_runtime_id)
       /\ UNCHANGED << meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_coordinator_bound, mob_member_state_markers, mob_wiring_edges, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "meerkat", variant |-> "PrepareBindings", payload |-> [agent_runtime_id |-> packet.payload.agent_runtime_id, fence_token |-> packet.payload.fence_token, generation |-> packet.payload.generation], source_kind |-> "route", source_route |-> "binding_request_reaches_meerkat", source_machine |-> "mob", source_effect |-> "RequestRuntimeBinding", effect_id |-> (model_step_count + 1)])
       /\ observed_inputs' = observed_inputs \cup {[machine |-> "meerkat", variant |-> "PrepareBindings", payload |-> [agent_runtime_id |-> packet.payload.agent_runtime_id, fence_token |-> packet.payload.fence_token, generation |-> packet.payload.generation], source_kind |-> "route", source_route |-> "binding_request_reaches_meerkat", source_machine |-> "mob", source_effect |-> "RequestRuntimeBinding", effect_id |-> (model_step_count + 1)]}
       /\ pending_routes' = pending_routes
...
mob_DestroyMob ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ mob_member_state_markers' = [x \in {} |-> None]
       /\ UNCHANGED << meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_current_run_id, meerkat_pre_run_phase, meerkat_silent_intent_overrides, meerkat_realtime_intent_present, meerkat_realtime_binding_state, meerkat_realtime_binding_authority_epoch, meerkat_realtime_reattach_required, meerkat_realtime_next_authority_epoch, meerkat_live_topology_phase, meerkat_mcp_server_states, meerkat_pending_peer_requests, meerkat_inbound_peer_requests, meerkat_last_session_context_updated_at_ms, mob_externally_addressable_runtime_ids, mob_wiring_edges, mob_identity_to_runtime, mob_tasks, mob_in_progress_task_ids, mob_completed_task_ids, witness_current_script_input, witness_remaining_script_inputs >>
...
EntryPacketAdmissible_meerkat(packet) ==
    ...
    \/ /\ (packet.variant = "AdvanceSessionContext") /\ (meerkat_phase = "Idle") /\ ((packet.payload.updated_at_ms > meerkat_last_session_context_updated_at_ms))
    \/ /\ (packet.variant = "AdvanceSessionContext") /\ (meerkat_phase = "Attached") /\ ((packet.payload.updated_at_ms > meerkat_last_session_context_updated_at_ms))
    \/ /\ (packet.variant = "AdvanceSessionContext") /\ (meerkat_phase = "Running") /\ ((packet.payload.updated_at_ms > meerkat_last_session_context_updated_at_ms))
    \/ /\ (packet.variant = "AdvanceSessionContext") /\ (meerkat_phase = "Retired") /\ ((packet.payload.updated_at_ms > meerkat_last_session_context_updated_at_ms))
    \/ /\ (packet.variant = "AdvanceSessionContext") /\ (meerkat_phase = "Stopped") /\ ((packet.payload.updated_at_ms > meerkat_last_session_context_updated_at_ms))
...
CoreNext ==
    ...
    \/ \E arg_updated_at_ms \in 0..2 : meerkat_AdvanceSessionContextIdle(arg_updated_at_ms)
    \/ \E arg_updated_at_ms \in 0..2 : meerkat_AdvanceSessionContextAttached(arg_updated_at_ms)
    \/ \E arg_updated_at_ms \in 0..2 : meerkat_AdvanceSessionContextRunning(arg_updated_at_ms)
    \/ \E arg_updated_at_ms \in 0..2 : meerkat_AdvanceSessionContextRetired(arg_updated_at_ms)
    \/ \E arg_updated_at_ms \in 0..2 : meerkat_AdvanceSessionContextStopped(arg_updated_at_ms)
