...
meerkat_AcceptWithCompletionIdle(arg_input_id, arg_request_immediate_processing, arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
...
meerkat_AcceptWithCompletionAttachedImmediate(arg_input_id, arg_request_immediate_processing, arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "AcceptWithCompletion"
       /\ packet.payload.input_id = arg_input_id
...
meerkat_AcceptWithCompletionAttachedQueued(arg_input_id, arg_request_immediate_processing, arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "AcceptWithCompletion"
       /\ packet.payload.input_id = arg_input_id
       ...
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
       /\ emitted_effects' = emitted_effects \cup { [machine |-> "meerkat", variant |-> "IngressAccepted", payload |-> [tag |-> "unit"], effect_id |-> (model_step_count + 1), source_transition |-> "AcceptWithCompletionAttachedQueued"] }
...
meerkat_AcceptWithCompletionRunning(arg_input_id, arg_request_immediate_processing, arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       /\ packet.machine = "meerkat"
       /\ packet.variant = "AcceptWithCompletion"
       /\ packet.payload.input_id = arg_input_id
...
EntryPacketAdmissible_meerkat(packet) ==
    ...
    \/ /\ (packet.variant = "AcceptWithCompletion") /\ (meerkat_phase = "Attached") /\ ((meerkat_session_id # None)) /\ ((packet.payload.request_immediate_processing = TRUE))
    \/ /\ (packet.variant = "AcceptWithCompletion") /\ (meerkat_phase = "Attached") /\ ((meerkat_session_id # None)) /\ ((packet.payload.request_immediate_processing = FALSE))
...
CoreNext ==
    ...
    \/ \E arg_input_id \in InputIdValues : \E arg_request_immediate_processing \in BOOLEAN : \E arg_run_id \in RunIdValues : meerkat_AcceptWithCompletionIdle(arg_input_id, arg_request_immediate_processing, arg_run_id)
    \/ \E arg_input_id \in InputIdValues : \E arg_request_immediate_processing \in BOOLEAN : \E arg_run_id \in RunIdValues : meerkat_AcceptWithCompletionAttachedImmediate(arg_input_id, arg_request_immediate_processing, arg_run_id)
    \/ \E arg_input_id \in InputIdValues : \E arg_request_immediate_processing \in BOOLEAN : \E arg_run_id \in RunIdValues : meerkat_AcceptWithCompletionAttachedQueued(arg_input_id, arg_request_immediate_processing, arg_run_id)
    \/ \E arg_input_id \in InputIdValues : \E arg_request_immediate_processing \in BOOLEAN : \E arg_run_id \in RunIdValues : meerkat_AcceptWithCompletionRunning(arg_input_id, arg_request_immediate_processing, arg_run_id)
