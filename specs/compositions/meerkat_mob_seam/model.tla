...
meerkat_ReconfigureSessionLlmIdentityAttached(arg_previous_identity, arg_previous_visibility_state, arg_previous_capability_surface, arg_previous_capability_surface_status, arg_target_identity, arg_target_capability_surface, arg_next_visibility_state, arg_next_capability_base_filter, arg_next_active_visibility_revision, arg_tool_visibility_delta) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_active_work_id, meerkat_attachment_live, meerkat_wake_pending, meerkat_process_pending, meerkat_pre_run_phase, meerkat_peer_ingress_configured, meerkat_drain_running, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_staged_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_StagePersistentFilterIdle(arg_filter, arg_witnesses) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_active_work_id, meerkat_attachment_live, meerkat_wake_pending, meerkat_process_pending, meerkat_pre_run_phase, meerkat_peer_ingress_configured, meerkat_drain_running, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_RequestDeferredToolsIdle(arg_names, arg_witnesses) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_staged_visibility_revision' = ((IF (meerkat_active_visibility_revision > meerkat_staged_visibility_revision) THEN meerkat_active_visibility_revision ELSE meerkat_staged_visibility_revision) + 1)
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_active_work_id, meerkat_attachment_live, meerkat_wake_pending, meerkat_process_pending, meerkat_pre_run_phase, meerkat_peer_ingress_configured, meerkat_drain_running, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_active_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_SetPeerIngressContextIdle(arg_keep_alive) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_active_work_id, meerkat_attachment_live, meerkat_wake_pending, meerkat_process_pending, meerkat_pre_run_phase, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_BoundaryAppliedPromote(arg_revision) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_active_work_id, meerkat_attachment_live, meerkat_wake_pending, meerkat_process_pending, meerkat_pre_run_phase, meerkat_peer_ingress_configured, meerkat_drain_running, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_staged_filter, meerkat_staged_requested_deferred_names, meerkat_staged_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_PublishCommittedVisibleSetIdle(arg_active_filter, arg_staged_filter, arg_active_requested_deferred_names, arg_staged_requested_deferred_names, arg_active_visibility_revision, arg_staged_visibility_revision) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_active_work_id, meerkat_attachment_live, meerkat_wake_pending, meerkat_process_pending, meerkat_pre_run_phase, meerkat_peer_ingress_configured, meerkat_drain_running, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_Reset ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_pre_run_phase' = None
       /\ meerkat_drain_running' = FALSE
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_attachment_live, meerkat_peer_ingress_configured, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
meerkat_Destroy ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_pre_run_phase' = None
       /\ meerkat_drain_running' = FALSE
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_attachment_live, meerkat_peer_ingress_configured, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
...
meerkat_RecycleFromIdleOrRetired ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ meerkat_peer_ingress_configured' = FALSE
       /\ meerkat_drain_running' = FALSE
       /\ UNCHANGED << meerkat_session_id, meerkat_active_runtime_id, meerkat_attachment_live, meerkat_pre_run_phase, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, mob_phase, mob_active_identity, mob_active_runtime_id, mob_active_fence_token, mob_current_generation, mob_inflight_work_id, mob_active_member_count, mob_active_run_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
...
mob_ObserveRuntimeRetired(arg_agent_runtime_id, arg_fence_token) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ mob_inflight_work_id' = None
       /\ mob_active_run_count' = 0
       /\ UNCHANGED << meerkat_phase, meerkat_session_id, meerkat_active_runtime_id, meerkat_active_fence_token, meerkat_active_generation, meerkat_active_work_id, meerkat_attachment_live, meerkat_wake_pending, meerkat_process_pending, meerkat_pre_run_phase, meerkat_peer_ingress_configured, meerkat_drain_running, meerkat_current_llm_identity, meerkat_current_capability_surface, meerkat_capability_surface_status, meerkat_capability_base_filter, meerkat_inherited_base_filter, meerkat_active_filter, meerkat_staged_filter, meerkat_active_requested_deferred_names, meerkat_staged_requested_deferred_names, meerkat_active_visibility_revision, meerkat_staged_visibility_revision, mob_active_identity, mob_current_generation, mob_active_member_count, mob_pending_spawn_count, mob_retiring_member_count, mob_wiring_edge_count, mob_task_count, mob_event_subscription_count, mob_coordinator_bound, witness_current_script_input, witness_remaining_script_inputs >>
       /\ pending_inputs' = SeqRemove(pending_inputs, packet)
       /\ observed_inputs' = observed_inputs
       /\ pending_routes' = pending_routes
       /\ delivered_routes' = delivered_routes
