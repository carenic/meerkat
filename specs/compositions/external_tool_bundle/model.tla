...
turn_execution_PrimitiveAppliedImmediateAppend(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           /\ pending_inputs' = AppendIfMissing(SeqRemove(pending_inputs, packet), [machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)])
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "PrimitiveAppliedImmediateAppend"] }
...
turn_execution_PrimitiveAppliedImmediateAppendCancelsAfterBoundary(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "PrimitiveAppliedImmediateAppendCancelsAfterBoundary"] }
...
turn_execution_PrimitiveAppliedImmediateContext(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "PrimitiveAppliedImmediateContext"] }
...
turn_execution_PrimitiveAppliedImmediateContextCancelsAfterBoundary(arg_run_id, arg_admitted_content_shape, arg_vision_enabled, arg_image_tool_results_enabled) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "PrimitiveAppliedImmediateContextCancelsAfterBoundary"] }
...
turn_execution_ToolCallsResolved(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "ToolCallsResolved"] }
...
turn_execution_LlmReturnedTerminal(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "LlmReturnedTerminal"] }
...
turn_execution_TurnLimitReachedFromApplyingPrimitive(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromApplyingPrimitive"] }
...
turn_execution_TurnLimitReachedFromCallingLlm(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromCallingLlm"] }
...
turn_execution_TurnLimitReachedFromWaitingForOps(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromWaitingForOps"] }
...
turn_execution_TurnLimitReachedFromDrainingBoundary(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromDrainingBoundary"] }
...
turn_execution_TurnLimitReachedFromExtracting(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromExtracting"] }
...
turn_execution_TurnLimitReachedFromErrorRecovery(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TurnLimitReachedFromErrorRecovery"] }
...
turn_execution_BudgetExhaustedFromApplyingPrimitive(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromApplyingPrimitive"] }
...
turn_execution_BudgetExhaustedFromCallingLlm(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromCallingLlm"] }
...
turn_execution_BudgetExhaustedFromWaitingForOps(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromWaitingForOps"] }
...
turn_execution_BudgetExhaustedFromDrainingBoundary(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromDrainingBoundary"] }
...
turn_execution_BudgetExhaustedFromExtracting(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromExtracting"] }
...
turn_execution_BudgetExhaustedFromErrorRecovery(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "BudgetExhaustedFromErrorRecovery"] }
...
turn_execution_TimeBudgetExceededFromApplyingPrimitive(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromApplyingPrimitive"] }
...
turn_execution_TimeBudgetExceededFromCallingLlm(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromCallingLlm"] }
...
turn_execution_TimeBudgetExceededFromWaitingForOps(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromWaitingForOps"] }
...
turn_execution_TimeBudgetExceededFromDrainingBoundary(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromDrainingBoundary"] }
...
turn_execution_TimeBudgetExceededFromExtracting(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromExtracting"] }
...
turn_execution_TimeBudgetExceededFromErrorRecovery(arg_run_id) ==
    /\ \E packet \in SeqElements(pending_inputs) :
       ...
       /\ \E route_owner_ctx_turn_boundary_applies_surface_changes_surface_id \in SurfaceIdValues, route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn \in TurnNumberValues :
           ...
           /\ observed_inputs' = observed_inputs \cup {[machine |-> "external_tool_surface", variant |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], source_kind |-> "route", source_route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", source_effect |-> "BoundaryApplied", effect_id |-> (model_step_count + 1)]}
           /\ pending_routes' = pending_routes
           /\ delivered_routes' = delivered_routes \cup { [route |-> "turn_boundary_applies_surface_changes", source_machine |-> "turn_execution", effect |-> "BoundaryApplied", target_machine |-> "external_tool_surface", target_input |-> "ApplyBoundary", payload |-> [applied_at_turn |-> route_owner_ctx_turn_boundary_applies_surface_changes_applied_at_turn, surface_id |-> route_owner_ctx_turn_boundary_applies_surface_changes_surface_id], actor |-> "surface_boundary", effect_id |-> (model_step_count + 1), source_transition |-> "TimeBudgetExceededFromErrorRecovery"] }
...
CoreNext ==
    ...
    \/ \E arg_run_id \in RunIdValues : \E arg_error \in StringValues : turn_execution_ExtractionValidationFailed(arg_run_id, arg_error)
...
WitnessTransitionOrder_surface_add_notifies_control_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "external_tool_surface" /\ earlier.transition = "ApplyBoundaryAdd" /\ later.machine = "runtime_control" /\ later.transition = "ExternalToolDeltaReceivedIdle" /\ earlier.step < later.step)
WitnessTransitionOrder_surface_add_notifies_control_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "ExternalToolDeltaReceivedIdle" /\ later.machine = "turn_execution" /\ later.transition = "BoundaryComplete" /\ earlier.step < later.step)
...
WitnessTransitionOrder_surface_completion_feedback_2 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "external_tool_surface" /\ earlier.transition = "ApplyBoundaryAdd" /\ later.machine = "runtime_control" /\ later.transition = "ExternalToolDeltaReceivedIdle" /\ earlier.step < later.step)
WitnessTransitionOrder_surface_completion_feedback_3 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "runtime_control" /\ earlier.transition = "ExternalToolDeltaReceivedIdle" /\ later.machine = "turn_execution" /\ later.transition = "BoundaryComplete" /\ earlier.step < later.step)
WitnessTransitionOrder_surface_completion_feedback_4 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "turn_execution" /\ earlier.transition = "BoundaryComplete" /\ later.machine = "external_tool_surface" /\ later.transition = "PendingSucceededAdd" /\ earlier.step < later.step)
WitnessTransitionOrder_surface_completion_feedback_5 == <> (\E earlier \in observed_transitions, later \in observed_transitions : /\ earlier.machine = "external_tool_surface" /\ earlier.transition = "PendingSucceededAdd" /\ later.machine = "external_tool_surface" /\ later.transition = "SnapshotAligned" /\ earlier.step < later.step)
