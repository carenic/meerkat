...
Next ==
    ...
    \/ \E work_id \in WorkIdValues : \E reason \in StringValues : AdmissionRejectedIdle(work_id, reason)
    \/ \E work_id \in WorkIdValues : \E reason \in StringValues : AdmissionRejectedRunning(work_id, reason)
    \/ \E work_id \in WorkIdValues : \E reason \in StringValues : AdmissionRejectedAttached(work_id, reason)
