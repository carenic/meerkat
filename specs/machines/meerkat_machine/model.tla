...
VARIABLES phase, model_step_count, session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides, staged_visibility_revision

vars == << phase, model_step_count, session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides, staged_visibility_revision >>
...
RegisterSessionIdle(arg_session_id) ==
    ...
    /\ UNCHANGED << active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides, staged_visibility_revision >>
...
ReconfigureSessionLlmIdentityAttached(previous_identity, previous_visibility_state, previous_capability_surface, previous_capability_surface_status, target_identity, target_capability_surface, next_visibility_state, next_capability_base_filter, next_active_visibility_revision, tool_visibility_delta) ==
    ...
    /\ (session_id # None)
    /\ (active_runtime_id # None)
    /\ ((next_active_visibility_revision = staged_visibility_revision) \/ (next_active_visibility_revision = (staged_visibility_revision + 1)))
    /\ phase' = "Attached"
    /\ model_step_count' = model_step_count + 1
    /\ staged_visibility_revision' = next_active_visibility_revision
...
PrepareBindingsInitializing(agent_runtime_id, fence_token, generation) ==
    ...
    /\ UNCHANGED << session_id, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides, staged_visibility_revision >>
...
BoundaryAppliedPublish(revision) ==
    /\ phase = "Running"
    /\ (revision <= staged_visibility_revision)
    /\ phase' = "Running"
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides, staged_visibility_revision >>


PublishCommittedVisibleSetIdle(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision) ==
    /\ phase = "Idle"
    /\ (session_id # None)
    /\ (active_visibility_revision >= arg_staged_visibility_revision)
    /\ ((active_visibility_revision # arg_staged_visibility_revision) \/ ((active_filter = staged_filter) /\ (active_requested_deferred_names = staged_requested_deferred_names)))
...
PublishCommittedVisibleSetAttached(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision) ==
    /\ phase = "Attached"
    /\ (session_id # None)
    /\ (active_visibility_revision >= arg_staged_visibility_revision)
    /\ ((active_visibility_revision # arg_staged_visibility_revision) \/ ((active_filter = staged_filter) /\ (active_requested_deferred_names = staged_requested_deferred_names)))
...
PublishCommittedVisibleSetRunning(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision) ==
    /\ phase = "Running"
    /\ (session_id # None)
    /\ (active_visibility_revision >= arg_staged_visibility_revision)
    /\ ((active_visibility_revision # arg_staged_visibility_revision) \/ ((active_filter = staged_filter) /\ (active_requested_deferred_names = staged_requested_deferred_names)))
...
PublishCommittedVisibleSetRetired(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision) ==
    /\ phase = "Retired"
    /\ (session_id # None)
    /\ (active_visibility_revision >= arg_staged_visibility_revision)
    /\ ((active_visibility_revision # arg_staged_visibility_revision) \/ ((active_filter = staged_filter) /\ (active_requested_deferred_names = staged_requested_deferred_names)))
...
PublishCommittedVisibleSetStopped(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision) ==
    /\ phase = "Stopped"
    /\ (session_id # None)
    /\ (active_visibility_revision >= arg_staged_visibility_revision)
    /\ ((active_visibility_revision # arg_staged_visibility_revision) \/ ((active_filter = staged_filter) /\ (active_requested_deferred_names = staged_requested_deferred_names)))
...
Reset ==
    ...
    /\ pre_run_phase' = None
    /\ silent_intent_overrides' = {}
    /\ UNCHANGED << session_id, active_runtime_id, attachment_live, staged_visibility_revision >>
...
StopRuntimeExecutorDetached ==
    ...
    /\ pre_run_phase' = None
    /\ silent_intent_overrides' = {}
    /\ UNCHANGED << session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, staged_visibility_revision >>
...
StopRuntimeExecutorLiveAttached ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ silent_intent_overrides' = {}
    /\ UNCHANGED << session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase, staged_visibility_revision >>
...
EnsureSessionWithExecutorIdle(arg_session_id) ==
    ...
    /\ UNCHANGED << session_id, active_runtime_id, active_fence_token, active_generation, current_run_id, pre_run_phase, silent_intent_overrides, staged_visibility_revision >>
...
AcceptWithCompletionAttachedImmediate(input_id, request_immediate_processing, interrupt_yielding, run_id) ==
    ...
    /\ UNCHANGED << session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, silent_intent_overrides, staged_visibility_revision >>
...
RecycleFromIdleOrRetired ==
    ...
    /\ active_generation' = None
    /\ current_run_id' = None
    /\ UNCHANGED << session_id, active_runtime_id, attachment_live, pre_run_phase, silent_intent_overrides, staged_visibility_revision >>
...
Next ==
    ...
    \/ \E active_filter \in ToolFilterValues : \E staged_filter \in ToolFilterValues : \E active_requested_deferred_names \in SetOfStringValues : \E staged_requested_deferred_names \in SetOfStringValues : \E active_visibility_revision \in 0..2 : \E arg_staged_visibility_revision \in 0..2 : PublishCommittedVisibleSetIdle(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision)
    \/ \E active_filter \in ToolFilterValues : \E staged_filter \in ToolFilterValues : \E active_requested_deferred_names \in SetOfStringValues : \E staged_requested_deferred_names \in SetOfStringValues : \E active_visibility_revision \in 0..2 : \E arg_staged_visibility_revision \in 0..2 : PublishCommittedVisibleSetAttached(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision)
    \/ \E active_filter \in ToolFilterValues : \E staged_filter \in ToolFilterValues : \E active_requested_deferred_names \in SetOfStringValues : \E staged_requested_deferred_names \in SetOfStringValues : \E active_visibility_revision \in 0..2 : \E arg_staged_visibility_revision \in 0..2 : PublishCommittedVisibleSetRunning(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision)
    \/ \E active_filter \in ToolFilterValues : \E staged_filter \in ToolFilterValues : \E active_requested_deferred_names \in SetOfStringValues : \E staged_requested_deferred_names \in SetOfStringValues : \E active_visibility_revision \in 0..2 : \E arg_staged_visibility_revision \in 0..2 : PublishCommittedVisibleSetRetired(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision)
    \/ \E active_filter \in ToolFilterValues : \E staged_filter \in ToolFilterValues : \E active_requested_deferred_names \in SetOfStringValues : \E staged_requested_deferred_names \in SetOfStringValues : \E active_visibility_revision \in 0..2 : \E arg_staged_visibility_revision \in 0..2 : PublishCommittedVisibleSetStopped(active_filter, staged_filter, active_requested_deferred_names, staged_requested_deferred_names, active_visibility_revision, arg_staged_visibility_revision)
    \/ RetireRequestedFromIdle
    \/ Reset
    \/ StopRuntimeExecutorDetached
    \/ StopRuntimeExecutorLiveAttached
