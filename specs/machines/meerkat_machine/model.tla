...
VARIABLES phase, model_step_count, session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides

vars == << phase, model_step_count, session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides >>
...
RegisterSessionIdle(arg_session_id) ==
    ...
    /\ UNCHANGED << active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides >>
...
PrepareBindingsInitializing(agent_runtime_id, fence_token, generation) ==
    ...
    /\ UNCHANGED << session_id, attachment_live, current_run_id, pre_run_phase, silent_intent_overrides >>
...
Reset ==
    ...
    /\ pre_run_phase' = None
    /\ silent_intent_overrides' = {}
    /\ UNCHANGED << session_id, active_runtime_id, attachment_live >>
...
StopRuntimeExecutorDetached ==
    ...
    /\ pre_run_phase' = None
    /\ silent_intent_overrides' = {}
    /\ UNCHANGED << session_id, active_runtime_id, active_fence_token, active_generation, attachment_live >>
...
StopRuntimeExecutorLiveAttached ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ silent_intent_overrides' = {}
    /\ UNCHANGED << session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, current_run_id, pre_run_phase >>
...
AcceptWithCompletionAttachedImmediate(input_id, request_immediate_processing, interrupt_yielding, run_id) ==
    ...
    /\ UNCHANGED << session_id, active_runtime_id, active_fence_token, active_generation, attachment_live, silent_intent_overrides >>
...
RecycleFromIdleOrRetired ==
    ...
    /\ active_generation' = None
    /\ current_run_id' = None
    /\ UNCHANGED << session_id, active_runtime_id, attachment_live, pre_run_phase, silent_intent_overrides >>
