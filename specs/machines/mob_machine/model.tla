...
VARIABLES phase, model_step_count, live_runtime_ids, runtime_fence_tokens, active_member_count, active_run_count, pending_spawn_count, wiring_edge_count, coordinator_bound

vars == << phase, model_step_count, live_runtime_ids, runtime_fence_tokens, active_member_count, active_run_count, pending_spawn_count, wiring_edge_count, coordinator_bound >>
...
ObserveWorkCompleted(agent_runtime_id, fence_token, work_id) ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ active_run_count' = 0
    /\ UNCHANGED << live_runtime_ids, runtime_fence_tokens, active_member_count, pending_spawn_count, wiring_edge_count, coordinator_bound >>
...
StopRunning ==
    ...
    /\ active_run_count' = 0
    /\ coordinator_bound' = FALSE
    /\ UNCHANGED << live_runtime_ids, runtime_fence_tokens, active_member_count, pending_spawn_count, wiring_edge_count >>
...
ResumeStopped ==
    ...
    /\ model_step_count' = model_step_count + 1
    /\ coordinator_bound' = TRUE
    /\ UNCHANGED << live_runtime_ids, runtime_fence_tokens, active_member_count, active_run_count, pending_spawn_count, wiring_edge_count >>
...
ResetToRunning ==
    ...
    /\ wiring_edge_count' = 0
    /\ coordinator_bound' = TRUE
    /\ UNCHANGED << live_runtime_ids, runtime_fence_tokens, active_member_count >>
...
WireRunning ==
    ...
    /\ UNCHANGED << live_runtime_ids, runtime_fence_tokens, active_member_count, active_run_count, pending_spawn_count, coordinator_bound >>
...
StageSpawnRunning ==
    ...
    /\ UNCHANGED << live_runtime_ids, runtime_fence_tokens, active_member_count, active_run_count, wiring_edge_count, coordinator_bound >>
...
CompleteSpawnRunning ==
    ...
    /\ active_member_count' = (active_member_count) + 1
    /\ pending_spawn_count' = (pending_spawn_count) - 1
    /\ UNCHANGED << live_runtime_ids, runtime_fence_tokens, active_run_count, wiring_edge_count, coordinator_bound >>
...
RespawnRunning(agent_runtime_id) ==
    ...
    /\ UNCHANGED << live_runtime_ids, active_member_count, active_run_count, pending_spawn_count, wiring_edge_count, coordinator_bound >>
...
CiStateConstraint == /\ model_step_count <= 6 /\ Cardinality(live_runtime_ids) <= 1 /\ Cardinality(DOMAIN runtime_fence_tokens) <= 1
DeepStateConstraint == /\ model_step_count <= 8 /\ Cardinality(live_runtime_ids) <= 2 /\ Cardinality(DOMAIN runtime_fence_tokens) <= 2
