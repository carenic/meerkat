...
VARIABLES phase, model_step_count, active_member_count, active_run_count, pending_spawn_count, wiring_edge_count, coordinator_bound

vars == << phase, model_step_count, active_member_count, active_run_count, pending_spawn_count, wiring_edge_count, coordinator_bound >>
...
ObserveRuntimeReady(agent_runtime_id, fence_token) ==
    ...
    /\ phase' = "Running"
    /\ model_step_count' = model_step_count + 1
    /\ UNCHANGED << active_member_count, active_run_count, pending_spawn_count, wiring_edge_count, coordinator_bound >>
...
StopRunning ==
    ...
    /\ active_run_count' = 0
    /\ coordinator_bound' = FALSE
    /\ UNCHANGED << active_member_count, pending_spawn_count, wiring_edge_count >>
...
ResumeStopped ==
    ...
    /\ UNCHANGED << active_member_count, active_run_count, pending_spawn_count, wiring_edge_count >>
...
WireRunning ==
    ...
    /\ UNCHANGED << active_member_count, active_run_count, pending_spawn_count, coordinator_bound >>
...
StageSpawnRunning ==
    ...
    /\ UNCHANGED << active_member_count, active_run_count, wiring_edge_count, coordinator_bound >>
...
CompleteSpawnRunning ==
    ...
    /\ active_member_count' = (active_member_count) + 1
    /\ pending_spawn_count' = (pending_spawn_count) - 1
    /\ UNCHANGED << active_run_count, wiring_edge_count, coordinator_bound >>
