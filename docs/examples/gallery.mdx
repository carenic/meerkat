...
description: "Runnable applications and focused patterns built with Meerkat, from session basics to browser war games."
icon: "rocket"
---

Runnable applications, focused demonstrations, and production-shaped patterns live in the [repository](https://github.com/lukacf/meerkat/tree/main/examples). For feature-by-feature code snippets, start with [Sessions & streaming](/examples/sessions).
...
<CardGroup cols={2}>
  ...
  <Card title="024 Multi-Turn Processing" icon="satellite-dish" href="https://github.com/lukacf/meerkat/tree/main/examples/024-host-mode-event-mesh-rs">
    **Rust** -- Standalone in-process session with directly submitted turns, retained context, and event streaming.
  </Card>
  <Card title="025 Composed Agent" icon="layer-group" href="https://github.com/lukacf/meerkat/tree/main/examples/025-full-stack-agent-rs">
...
<CardGroup cols={2}>
  ...
  <Card title="031 Mini Diplomacy Arena" icon="chess" href="https://github.com/lukacf/meerkat/tree/main/examples/031-wasm-mini-diplomacy-sh">
  ...
  <Card title="037 Live WebRTC Cockpit" icon="video" href="https://github.com/lukacf/meerkat/tree/main/examples/037-live-webrtc-web">
