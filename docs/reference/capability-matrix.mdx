...
# Add persistence
meerkat = { version = "=0.8.25", default-features = false, features = ["anthropic", "session-store"] }

# Add compaction
meerkat = { version = "=0.8.25", default-features = false, features = ["anthropic", "session-store", "session-compaction"] }

# Add facade-local predicate-schedule helper re-exports. The schedule service
# and WorkGraph substrate are already linked.
meerkat = { version = "=0.8.25", default-features = false, features = ["anthropic", "session-store", "schedule"] }
...
meerkat = { version = "=0.8.25", features = ["openai-realtime", "live-webrtc"] }
```
