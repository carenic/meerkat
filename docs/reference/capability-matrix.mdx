...
[dependencies]
meerkat = { version = "0.8.17", default-features = false, features = ["anthropic"] }

# Add persistence
meerkat = { version = "0.8.17", default-features = false, features = ["anthropic", "session-store"] }

# Add compaction
meerkat = { version = "0.8.17", default-features = false, features = ["anthropic", "session-store", "session-compaction"] }

# Add scheduling
meerkat = { version = "0.8.17", default-features = false, features = ["anthropic", "session-store", "schedule"] }

# Kitchen sink
meerkat = { version = "0.8.17", features = [
