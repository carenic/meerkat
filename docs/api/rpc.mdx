...
| `runtime/session_status` | Runtime | Get a session's current runtime state |
| `runtime/session_submit` | Runtime | Accept a runtime input for a session |
| `runtime/session_submission` | Runtime | Get a runtime input state |
| `runtime/session_submissions` | Runtime | List active runtime inputs |
| `runtime/session_retire` | Runtime | Retire a session runtime |
| `runtime/session_reset` | Runtime | Reset a session runtime |
