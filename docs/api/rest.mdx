...
| `GET` | `/sessions/{id}/runtime-state` | Read runtime state |
| `GET` | `/sessions/{id}/realtime-attachment-status` | Read the runtime-owned realtime attachment status for a session |
| `POST` | `/sessions/{id}/accept-input` | Admit runtime input explicitly |
| `POST` | `/sessions/{id}/retire-runtime` | Retire a runtime |
| `POST` | `/sessions/{id}/reset-runtime` | Reset a runtime |
